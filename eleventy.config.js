...
export default function (eleventyConfig) {
  ...
  eleventyConfig.addPlugin(feedPlugin, {
    ...
    metadata: {
      ...
      subtitle:
        "Project website. All my projects bundled into one, here you can check out my projects and check what you want to use maybe. I like to use css, javascript, npm, bootstrap, symfony, 11ty and such.",
